  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-16 sm:py-24 flex flex-col justify-center w-full">
        ...
        <section className="bg-slate-900 border border-slate-800 p-6 rounded-2xl mb-12 shadow-2xl">
          ...
          <div className="relative mb-2">
            <input 
              ...
              className="w-full bg-slate-950 text-white rounded-xl py-3 pl-11 pr-4 border border-slate-800 focus:outline-none focus:border-teal-500 transition-colors placeholder-slate-600 text-sm"
            />
            ...
            <div className="mt-4 border-t border-slate-800 pt-4 space-y-3">
              ...
              {filteredResults.map((result) => (
                <a 
                  ...
                  className="block p-3 rounded-xl bg-slate-950 hover:bg-slate-900/50 border border-slate-900 hover:border-slate-800 transition-all text-left"
                >
        ...
        <section className="text-left">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <button 
              ...
              className="flex items-center gap-3 p-4 rounded-xl bg-slate-900/40 border border-slate-800/60 hover:bg-slate-900 transition-all text-left group"
            >
